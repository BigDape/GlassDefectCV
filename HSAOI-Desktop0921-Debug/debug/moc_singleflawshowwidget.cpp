...
#include <memory>
#include "../../HSAOI_Demo_0920_1/Form/singleflawshowwidget.h"
...
QT_MOC_LITERAL(5, 45, 8), // "sig_test"
QT_MOC_LITERAL(6, 54, 13), // "showFlawImage"
QT_MOC_LITERAL(7, 68, 17), // "QTableWidgetItem*"
QT_MOC_LITERAL(8, 86, 4), // "item"
QT_MOC_LITERAL(9, 91, 19), // "onItemDoubleClicked"
QT_MOC_LITERAL(10, 111, 14), // "slot_RecieveID"
QT_MOC_LITERAL(11, 126, 12), // "jsonFullPath"
QT_MOC_LITERAL(12, 139, 7), // "glassid"
QT_MOC_LITERAL(13, 147, 14), // "slot_FlawTrack"
QT_MOC_LITERAL(14, 162, 24), // "slot_ButtonExportClicked"
QT_MOC_LITERAL(15, 187, 15) // "slot_refrshFlaw"

    },
    "SingleFlawShowWidget\0sig_paintFlawPoint\0"
    "\0x\0y\0sig_test\0showFlawImage\0"
    "QTableWidgetItem*\0item\0onItemDoubleClicked\0"
    "slot_RecieveID\0jsonFullPath\0glassid\0"
    "slot_FlawTrack\0slot_ButtonExportClicked\0"
    "slot_refrshFlaw"
};
...
void SingleFlawShowWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sig_test(); break;
        case 2: _t->showFlawImage((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1]))); break;
        case 3: _t->onItemDoubleClicked((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1]))); break;
        case 4: _t->slot_RecieveID((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 5: _t->slot_FlawTrack((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1]))); break;
        case 6: _t->slot_ButtonExportClicked(); break;
        case 7: _t->slot_refrshFlaw((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (SingleFlawShowWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SingleFlawShowWidget::sig_test)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void SingleFlawShowWidget::sig_test()
{
