...
#include <memory>
#include "../../../HSAOI_Demo_0920_1/log/log4qt/databaselayout.h"
...
QT_MOC_LITERAL(2, 39, 15), // "loggenameColumn"
QT_MOC_LITERAL(3, 55, 16), // "threadNameColumn"
QT_MOC_LITERAL(4, 72, 11), // "levelColumn"
QT_MOC_LITERAL(5, 84, 13) // "messageColumn"

    },
    "Log4Qt::DatabaseLayout\0timeStampColumn\0"
    "loggenameColumn\0threadNameColumn\0"
...
void Log4Qt::DatabaseLayout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<DatabaseLayout *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->timeStampColumn(); break;
        case 1: *reinterpret_cast< QString*>(_v) = _t->loggenameColumn(); break;
        ...
        case 1: _t->setLoggenameColumn(*reinterpret_cast< QString*>(_v)); break;
...
QT_INIT_METAOBJECT const QMetaObject Log4Qt::DatabaseLayout::staticMetaObject = { {
    QMetaObject::SuperData::link<Layout::staticMetaObject>(),
    qt_meta_stringdata_Log4Qt__DatabaseLayout.data,
    qt_meta_data_Log4Qt__DatabaseLayout,
    qt_static_metacall,
    nullptr,
    nullptr
} };
