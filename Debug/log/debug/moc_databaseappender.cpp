...
#include <memory>
#include "../../../HSAOI_Demo_0920_1/log/log4qt/databaseappender.h"
...
void Log4Qt::DatabaseAppender::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<DatabaseAppender *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Log4Qt::DatabaseAppender::staticMetaObject = { {
    QMetaObject::SuperData::link<AppenderSkeleton::staticMetaObject>(),
    qt_meta_stringdata_Log4Qt__DatabaseAppender.data,
    qt_meta_data_Log4Qt__DatabaseAppender,
    qt_static_metacall,
    nullptr,
    nullptr
} };
