...
#include <memory>
#include "../../../HSAOI_Demo_0920_1/main/Form/DataAnalysis.h"
...
QT_MOC_LITERAL(1, 13, 14), // "slotSearchData"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 13), // "slotClearData"
QT_MOC_LITERAL(4, 43, 17), // "slotDisplayDefect"
QT_MOC_LITERAL(5, 61, 17), // "QTableWidgetItem*"
QT_MOC_LITERAL(6, 79, 4), // "item"
QT_MOC_LITERAL(7, 84, 16) // "slotDisplayImage"

    },
    "DataAnalysis\0slotSearchData\0\0slotClearData\0"
    "slotDisplayDefect\0QTableWidgetItem*\0"
    "item\0slotDisplayImage"
};
...
void DataAnalysis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotSearchData(); break;
        case 1: _t->slotClearData(); break;
        case 2: _t->slotDisplayDefect((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1]))); break;
        case 3: _t->slotDisplayImage((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
