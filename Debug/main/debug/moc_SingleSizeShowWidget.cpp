...
#include <memory>
#include "../../../HSAOI_Demo_0920_1/main/Form/SingleSizeShowWidget.h"
...
QT_MOC_LITERAL(1, 21, 23), // "slot_showSizeSmallImage"
QT_MOC_LITERAL(2, 45, 0), // ""
QT_MOC_LITERAL(3, 46, 17), // "QTableWidgetItem*"
QT_MOC_LITERAL(4, 64, 4), // "item"
QT_MOC_LITERAL(5, 69, 24), // "slot_onItemDoubleClicked"
QT_MOC_LITERAL(6, 94, 16), // "slot_refreshSize"
QT_MOC_LITERAL(7, 111, 12), // "jsonFilePath"
QT_MOC_LITERAL(8, 124, 7) // "glassid"

    },
    "SingleSizeShowWidget\0slot_showSizeSmallImage\0"
    "\0QTableWidgetItem*\0item\0"
    "slot_onItemDoubleClicked\0slot_refreshSize\0"
    "jsonFilePath\0glassid"
};
...
void SingleSizeShowWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slot_showSizeSmallImage((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1]))); break;
        case 1: _t->slot_onItemDoubleClicked((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1]))); break;
        case 2: _t->slot_refreshSize((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
