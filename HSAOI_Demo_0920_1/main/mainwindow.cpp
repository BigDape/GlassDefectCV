...
void MainWindow::initMenu()
{
    ...
    ui->toolBar->addWidget(m_pIconLabel);//添加图标

    QLabel *m_CurrentRecipeLabel = new QLabel(this);
    m_CurrentRecipeLabel->setGeometry(1650,0,300,56);
    m_CurrentRecipeLabel->setFixedSize(300, 56);
    QFont ft;
    ft.setPointSize(12);
    m_CurrentRecipeLabel->setFont(ft);
    ui->toolBar->addWidget(m_CurrentRecipeLabel);//添加工单
...
//    emit sig_FlawWidgetChange();//更新缺陷检出图像的长和宽
