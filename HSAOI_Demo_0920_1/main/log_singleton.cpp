...
QListWidget* log_singleton::widget0 = nullptr;
...
void log_singleton::Write_Log(const QString& Log_message, Log_Level Log_level)
{
    ...
    QString message = "[" + QDateTime::currentDateTime().toString("yyyy-MM-dd hh-mm-ss.zzz") + "] " + Log_message;
    if (Log_File.isOpen()) {
...
void log_singleton::InsertInfo(const QString& Log_message, Log_Level Log_level)
{
    QListWidgetItem* item = new QListWidgetItem();
    item->setText(Log_message);
    QFont font;
    font.setFamily("微软雅黑");
