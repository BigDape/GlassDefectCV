...
void Jsoncpp::readRecipeFromJson(QString path, SignalControl& signalCtrl)
{
    ...
    if(!root.empty()) {
        ...
        //尺寸测量
        signalCtrl.YAccuracyB = root["DimensionalMeasurementParams"]["YAccuracyB"].asDouble();
        signalCtrl.YAccuracyK = root["DimensionalMeasurementParams"]["YAccuracyK"].asDouble();
        signalCtrl.Width = root["DimensionalMeasurementParams"]["Width"].asDouble();
        signalCtrl.WidthDeviation = root["DimensionalMeasurementParams"]["WidthDeviation"].asDouble();
        signalCtrl.Digonal1 = root["DimensionalMeasurementParams"]["Digonal1"].asDouble();
        signalCtrl.Digonal1Deviation = root["DimensionalMeasurementParams"]["Digonal1Deviation"].asDouble();
        signalCtrl.Diagonal2 = root["DimensionalMeasurementParams"]["Diagonal2"].asDouble();
        signalCtrl.Digonal2Deviation = root["DimensionalMeasurementParams"]["Digonal2Deviation"].asDouble();
        signalCtrl.Camera1Pixel0Accuracy = root["DimensionalMeasurementParams"]["Camera1Pixel0Accuracy"].asDouble();
        signalCtrl.Camera1PixelKValue = root["DimensionalMeasurementParams"]["Camera1PixelKValue"].asDouble();
        signalCtrl.Camera21AccuracyRatio = root["DimensionalMeasurementParams"]["Camera21AccuracyRatio"].asDouble();
        signalCtrl.Camera2PixelKValue = root["DimensionalMeasurementParams"]["Camera2PixelKValue"].asDouble();
        signalCtrl.Length = root["DimensionalMeasurementParams"]["Length"].asDouble();
        signalCtrl.LengthDeviation = root["DimensionalMeasurementParams"]["LengthDeviation"].asDouble();
        //相机参数
...
void Jsoncpp::writeRecipeToJson(QString fullpath, SignalControl signalCtrl)
{
    ...
    //尺寸测量
    root["DimensionalMeasurementParams"]["YAccuracyB"] = signalCtrl.YAccuracyB;
    root["DimensionalMeasurementParams"]["YAccuracyK"] = signalCtrl.YAccuracyK;
    root["DimensionalMeasurementParams"]["Width"] = signalCtrl.Width;
    root["DimensionalMeasurementParams"]["WidthDeviation"] = signalCtrl.WidthDeviation;
    root["DimensionalMeasurementParams"]["Digonal1"] = signalCtrl.Digonal1;
    root["DimensionalMeasurementParams"]["Digonal1Deviation"] = signalCtrl.Digonal1Deviation;
    root["DimensionalMeasurementParams"]["Diagonal2"] = signalCtrl.Diagonal2;
    root["DimensionalMeasurementParams"]["Digonal2Deviation"] = signalCtrl.Digonal2Deviation;
    root["DimensionalMeasurementParams"]["Camera1Pixel0Accuracy"] = signalCtrl.Camera1Pixel0Accuracy;
    root["DimensionalMeasurementParams"]["Camera1PixelKValue"] = signalCtrl.Camera1PixelKValue;
    root["DimensionalMeasurementParams"]["Camera21AccuracyRatio"] = signalCtrl.Camera21AccuracyRatio;
    root["DimensionalMeasurementParams"]["Camera2PixelKValue"] = signalCtrl.Camera2PixelKValue;
    root["DimensionalMeasurementParams"]["Length"] = signalCtrl.Length;
    root["DimensionalMeasurementParams"]["LengthDeviation"] = signalCtrl.LengthDeviation;
    //相机参数
