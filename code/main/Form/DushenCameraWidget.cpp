    ...
    , ui(new Ui::DushenCameraWidget)
{
    ...
    // 初始化相机操作对象
    //
    CameraObject = CameraNameSpace::createCameraObject();
    ...
    connect(ui->cbx_SoftTrigger,SIGNAL(stateChanged(int)),this,SLOT(on_pushButton_trigger_clicked(int)));           // 触发选择框
...
void DushenCameraWidget::on_pushButton_trigger_clicked(int status)
{
